...
public:
  Grid() = default;
  Grid(const glm::vec2& size, const glm::uvec2& cells, const glm::vec4& color, bool edge = true,
      float line_width = 1.0f);

  void init(const glm::vec2& size, const glm::uvec2& cells, const glm::vec4& color,
      bool edge = true, float line_width = 1.0f);
