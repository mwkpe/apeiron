...
public:
  ...
  void set_tile_spacing(const std::vector<std::tuple<float, float>>& tile_spacing);
  void set_tile_spacing(std::vector<std::tuple<float, float>>&& tile_spacing);
...
private:
  ...
  std::vector<std::tuple<float, float>> tile_spacing_;
