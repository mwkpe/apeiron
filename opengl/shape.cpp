...
template void Shape::set_buffers(const std::vector<Vertex>& vertices);
template void Shape::set_buffers(const std::vector<Vertex_simple>& vertices);
template void Shape::set_buffers(const std::vector<Vertex_normal>& vertices);
template void Shape::set_buffers(const std::vector<Vertex_color>& vertices);
template void Shape::set_buffers(const std::vector<Vertex_texcoords>& vertices);
template void Shape::set_buffers(const std::vector<Vertex_normal_color>& vertices);
template void Shape::set_buffers(const std::vector<Vertex_normal_texcoords>& vertices);
